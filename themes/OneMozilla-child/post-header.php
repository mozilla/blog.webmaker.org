<?php if ( 'post' == get_post_type() ) : // No posted date for Pages ?>
  <div class="entry-posted-container">
...
<div class="entry-header-title-author">
  ...
  <?php if ( get_option('onemozilla_hide_authors') != 1 ) : ?>
    <cite class="author fn"><a class="url" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) ?>" title="<?php printf( esc_attr__( 'See all %1$s posts by %2$s', 'onemozilla'), get_the_author_posts(), get_the_author() ); ?>"><?php esc_html(the_author()); ?></a></cite>
  <?php endif; ?>
</div>
